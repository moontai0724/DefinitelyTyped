 ...
 *   Templating](https://spec.openapis.org/oas/v3.0.3#pathTemplating), where the
 ...
 *
 * @see https://spec.openapis.org/oas/v3.0.3#parameter-locations
 */
export type ParameterLocation = 'path' | 'query' | 'header' | 'cookie';

/**
 * Path-style parameters defined by
 * \[[RFC6570](https://spec.openapis.org/oas/v3.0.3#bib-RFC6570)\]
 */
 ...
 * \[[RFC6570](https://spec.openapis.org/oas/v3.0.3#bib-RFC6570)\]. This option
...
/**
 * Space separated array values. This option replaces `collectionFormat` equal
 * to `ssv` from OpenAPI 2.0.
 */
export type SpaceDelimitedStyle = 'spaceDelimited';
/**
 * Pipe separated array values. This option replaces `collectionFormat` equal to
 * `pipes` from OpenAPI 2.0.
 */
...
interface BaseParameter extends Extendable {
     ...
     *
     * The `name` corresponds to the parameter name used by the
     * [`in`](https://spec.openapis.org/oas/v3.0.3#parameterIn) property.
     */
    name: string;
    /**
 ...
 * [`schema`](https://spec.openapis.org/oas/v3.0.3#parameterSchema) and
 * [`style`](https://spec.openapis.org/oas/v3.0.3#parameterStyle) can describe
...
export interface SimpleBaseParameter
     ...
     * [`style`](https://spec.openapis.org/oas/v3.0.3#parameterStyle) is `form`,
 ...
 * [`content`](https://spec.openapis.org/oas/v3.0.3#parameterContent) property
...
interface PathParameterOptions {
     ...
     * The name of the parameter. Parameter names are _case sensitive_.
     *
     * If [`in`](https://spec.openapis.org/oas/v3.0.3#parameterIn) is `"path"`,
     * the `name` field _MUST_ correspond to a template expression occurring
     * within the [path](https://spec.openapis.org/oas/v3.0.3#pathsPath) field
     * in the [Paths Object](https://spec.openapis.org/oas/v3.0.3#pathsObject).
     * See [Path
     * Templating](https://spec.openapis.org/oas/v3.0.3#pathTemplating) for
     * further information.
     */
    name: string;
    in: 'path';
     ...
     * location](https://spec.openapis.org/oas/v3.0.3#parameterIn) is `"path"`,
...
interface QueryParameterOptions {
     ...
     * [`style`](https://spec.openapis.org/oas/v3.0.3#parameterStyle) is used,
     ...
     * \[[RFC3986](https://spec.openapis.org/oas/v3.0.3#bib-RFC3986)\]
...
interface HeaderParameterOptions {
     ...
     * The name of the parameter. Parameter names are _case sensitive_.
     *
     * If [`in`](https://spec.openapis.org/oas/v3.0.3#parameterIn) is `"header"`
