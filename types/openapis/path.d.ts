 ...
 * Object`](https://spec.openapis.org/oas/v3.0.3#serverObject) in order to
 * construct the full URL. The Paths _MAY_ be empty, due to [ACL
 * constraints](https://spec.openapis.org/oas/v3.0.3#securityFiltering).
 *
...
export interface Paths extends Extendable {
     ...
     * Object`](https://spec.openapis.org/oas/v3.0.3#serverObject)’s `url` field
     * in order to construct the full URL. [Path
     * templating](https://spec.openapis.org/oas/v3.0.3#pathTemplating) is
 ...
 * empty, due to [ACL
 * constraints](https://spec.openapis.org/oas/v3.0.3#securityFiltering). The
...
export interface PathItem extends Referable, Extendable {
     ...
     * structure _MUST_ be in the format of a [Path Item
     * Object](https://spec.openapis.org/oas/v3.0.3#pathItemObject). In case a
     ...
     * a [name](https://spec.openapis.org/oas/v3.0.3#parameterName) and
